...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingImage:(UIImage *)image editingInfo:(NSDictionary *)editingInfo
{
    ...
    NSLog(@"saveImg.size.width＝%f",saveImg.size.width);
    NSLog(@"saveImg.size.height=%f",saveImg.size.height);
    ...
    */
    ...
    UIImage* newSaveImg = [self scaleFromImage:saveImg toSize:CGSizeMake(saveImg.size.width/2, saveImg.size.height/2)];
    
    NSData * saveImgData = UIImageJPEGRepresentation(newSaveImg,0.1);
