...
public class UserexchnageController extends BaseController {
	...
	public String mainPage() {
		return "/hps/userexchnage/userexchnage_main";
	}

	@RequestMapping("/list")
	public String listPage() {
		return "/hps/userexchnage/userexchnage_list";
	}
	...
	public String addUserexchnageFormPage(Map<String, Object> map, HttpServletRequest request) {		
		...
		return "/hps/userexchnage/userexchnage_form"; 
	}
	...
	public void handle(PrintWriter writer, String id) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			boolean result = userexchnageService.handleUserExchange(id);
			map.put("success", result);
		} catch (Exception e) {
			map.put("success", false);
			map.put("msg", "处理失败");
