  ...
  $.fn.timePicker = function(options) {
    ...
    return this.each(function() {
    	...
    	if(this.getAttribute("timePicker")){
	    	var param = this.getAttribute("timePicker").split(",");
	    	var st = param[1].split(":");
	    	var et = param[2].split(":");
	
	    	var opt = {
	    		step : Number(param[0]),
	    		startTime : new Date(0, 0, 0, Number(st[0]), Number(st[1]), 0),
	    		endTime : new Date(0, 0, 0, Number(et[0]), Number(et[1]), 0)
	    	};
