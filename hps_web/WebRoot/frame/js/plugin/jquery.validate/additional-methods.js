...
jQuery.validator.addMethod("password", function(value, element){
	...
	return this.optional(element) || (value.length >= 6 && pattern.test(value) && value.length <= 20);
}, "密码字母有大小写之分，6～20位，限用字母、数字、下划线，必须包含字母和数字");
...
//samelen,两个值的长度要一样
jQuery.validator.addMethod("sametext", function(value, element,param) {
	/*分解参数,是否有,*/
	var otherObj = $(param);
	value = value.trim();
	var ok = true;
