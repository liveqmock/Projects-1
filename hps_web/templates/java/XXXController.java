...
public class ${classNamePrefix}Controller extends BaseController {
	...
	public String mainPage() {
		return "/hps/${params.moduleName}/${params.moduleName}_main";
	}

	@RequestMapping("/list")
	public String listPage() {
		return "/hps/${params.moduleName}/${params.moduleName}_list";
	}
	...
	public String add${classNamePrefix}FormPage(Map<String, Object> map, HttpServletRequest request) {		
		...
		return "/hps/${params.moduleName}/${params.moduleName}_form"; 
	}
