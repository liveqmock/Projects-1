...
<nui:head plugin="validate"
	title="${operation eq 'add'?'添加':(operation eq 'edit'?'编辑':'查看')}部门">
	<script type="text/javascript"
		src="${ctx}/frame/system/orgUnitMgr/departmentForm.js"></script>
</nui:head>
<nui:body>
	...
	<nui:panel style="width:800px;margin:20px auto;"
		...
		<form id="orgForm">
			...
			<nui:field type="input">
				<nui:input title="部门名称：" size="x2" require="true">
					<input type="text" id="orgName" name="orgName"
						value="${orgUnit.orgName}" required="true" maxlength="100" />
				</nui:input>
				<nui:input title="部门简称：" size="x1" require="true">
					<input type="text" id="orgShortName" name="orgShortName"
						value="${orgUnit.orgShortName}" required="true" maxlength="25" />
				</nui:input>
				
			</nui:field>
			<nui:field type="input">
				<nui:input title="部门传真：" size="x1">
					<input type="text" id="orgFax" name="orgFax"
						value="${orgUnit.orgFax}" maxlength="25" />
				</nui:input>
				<nui:input title="部门电话：" size="x1">
			...
			<nui:field type="button"
				...
				<input type="hidden" name="orgType" value="false" />
				<input type="hidden" id="orgId" name="orgId"
					value="${orgUnit.orgId}" />
				<input type="hidden" id="orgEngName" name="orgEngName" value="" />
				<input type="hidden" id="orgLevelCode" name="orgLevelCode" value="" />
