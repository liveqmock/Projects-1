...
<script type="text/javascript"
	src="${ctx}/hps/userapprove/userList.js"></script>
...
<nui:grid id="userListGrid" title="用户列表" offsetHeight="-60"
	url="${ctx}/hps/userMgr/loadUserListData"
	pageId="userlistPageId" pkName="userId" 
	otherButtons="{'operator':'User_Approve','name':'分配权限','onClick':'UserList.approveUser'}">
